const datas = [
    {
      questions: "How to Reduce CSS/JS Bundle Size By Removing Unused Resource Files and Resource Files",
    ...
    {
      questions: "What are the benefits of using a CSS framework?",
    ...
    {
      questions: "How can I improve the SEO of my website?",
    ...
    {
      questions: "What are the advantages of using a JavaScript framework?",
    ...
    {
      questions: "What are some best practices for writing clean and maintainable code?",
